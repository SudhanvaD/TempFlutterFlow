...
import 'services_pop_up_model.dart';
export 'services_pop_up_model.dart';

class ServicesPopUpWidget extends StatefulWidget {
  const ServicesPopUpWidget({
    Key? key,
    this.cardNumber,
  }) : super(key: key);
  ...
  @override
  _ServicesPopUpWidgetState createState() => _ServicesPopUpWidgetState();
}

class _ServicesPopUpWidgetState extends State<ServicesPopUpWidget> {
  late ServicesPopUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServicesPopUpModel());
  }
